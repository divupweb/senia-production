...
export class SwitchCheckboxChange {
  source: SwitchCheckboxComponent;
  checked: boolean;
}
...
@Component({
  ...
  templateUrl: './switch-checkbox.html',
  styleUrls: [ 'switch-checkbox.scss' ],
...
export class SwitchCheckboxComponent {
  ...
  @Input() id: string = `switch-checkbox-${++nextId}`;
  ...
  @Output() change: EventEmitter<SwitchCheckboxChange> = new EventEmitter<SwitchCheckboxChange>();
  ...
  private _emitChangeEvent() {
    let event = new SwitchCheckboxChange();
    event.source = this;
